...
qsjloop: // find rightmost number less than pivot at, save index to a3
	...
	bgt qsjloop
	cmp a2, a3
	bllt swap // swap if out of order (could save 3 instructions by avoiding helper function)
	blt qsiloop // repeat if maybe more out of order elements
	mov a2, a4
	bl swap // swap pivot with last number smaller than it (could save 4 instructions by avoiding helper function)
	sub a3, a3, #1
	bl quicksort
	add a2, a3, #2
	pop {a3, v1, v2, lr}
